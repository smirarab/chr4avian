...
plot_ribbon_tab |> 
  ...
  geom_ribbon(aes(x = position, ymin=ymin,ymax=ymax,  fill = val, group = name, 
                  alpha = ifelse(name == 'V0', 'Shallow', 'Deep')))+
  facet_wrap(~chr+sp,scales = "free", shrink = T,ncol=1)+
  theme_classic() +
  scale_x_continuous(expand = expansion(0, 0)) +
  scale_alpha_discrete(range = c(0.5, 0.3)) +
  labs(color = 'Topology', fill = 'Topology', 
       linetype = 'Coalescence', alpha = 'Coalescence')
